...
//                 <p className="text-white text-lg font-semibold">{selectedService} POP</p>
//               </div>
//             </motion.div>
        ...
        {!selectedService ? (
          ...
          <div>
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-lg">
                <p className="text-white text-lg font-semibold">{`${t('popWork.overlay')} ${selectedService} POP`}</p>
              </div>
            </motion.div>
