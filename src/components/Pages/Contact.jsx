...
//   return (
//     <div className="min-h-screen bg-gradient-to-r from-slate-900 to-blue-900 flex items-center justify-center px-4 py-12 mt-5">
      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-6xl w-full bg-black bg-opacity-50 backdrop-blur-lg rounded-xl p-8 text-white">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 bg-opacity-70 rounded-lg p-6 space-y-4">
          <div className="flex gap-4">
            <div className="w-full">
              <input name="name" value={formData.name} onChange={handleChange}
                type="text" placeholder={t('contact.form.name')} className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-md" />
              {errors.name && <p className="text-red-400 text-sm mt-1">{errors.name}</p>}
            </div>
          ...
          <div className="flex gap-4">
            <div className="w-full">
              <input name="email" value={formData.email} onChange={handleChange}
                type="email" placeholder={t('contact.form.email')} className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-md" />
              {errors.email && <p className="text-red-400 text-sm mt-1">{errors.email}</p>}
            </div>

            <div className="w-full">
              <input name="phone" value={formData.phone} onChange={handleChange}
                type="tel" placeholder={t('contact.form.phone')} className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-md" />
              {errors.phone && <p className="text-red-400 text-sm mt-1">{errors.phone}</p>}
            </div>
          </div>
          ...
          <div>
            <textarea name="message" value={formData.message} onChange={handleChange}
              rows={4} placeholder={t('contact.form.message')} className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-md resize-none"></textarea>
            {errors.message && <p className="text-red-400 text-sm mt-1">{errors.message}</p>}
          </div>
