...
import { 
  TreePine, Building2, Boxes, Martini, WrenchIcon, Chair, Sofa 
...
//   { name: 'Plastic furniture', icon: <Chair size={28} /> },
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex justify-center items-center px-2">
      <div className="bg-white rounded-2xl p-6 max-w-3xl w-full shadow-xl relative">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-800">All Furniture Plannings</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {furnitureItems.map((item, idx) => (
            ...
            >
              ...
              <p className="font-medium text-gray-700 text-center">{item.name}</p>
            </div>
          ))}
        </div>
      </div>
